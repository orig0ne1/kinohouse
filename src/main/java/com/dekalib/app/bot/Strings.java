...
public class Strings {
    ...
    public static String WEB_BOOK_NOTIFICATION = """
            📚 *Реферер перешел на страницу с вводом контактных данных!*
            🌐 *IP:* %s
            🎟️ *promo:* %s
            """;

    public static String WEB_TARIF_NOTIFICATION = """
            💳 *Реферер перешел на страницу с выбором тарифа!*
            🌐 *IP:* %s
            🎟️ *promo:* %s
            """;

    public static String WEB_CONTACT_INFO_NOTIFICATION = """
            📇 *Реферер ввёл контактные данные:*
            🌐 *IP:* %s
            👷 *Воркер:* %s
            🧑‍💼 *ФИО:* %s
            📞 *Телефон:* %s
    ...
    public static String WEB_ABOUT_NOTIFICATION = """
            ℹ️ *Реферер перешел на страницу 'О нас'!*
            🌐 *IP:* %s
            🎟️ *promo:* %s
            """;
